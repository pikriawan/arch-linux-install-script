...
if ! pacman -Qi yaru-theme &>/dev/null; then
    if [[ ! -f yaru-theme.tar.gz ]]; then
        curl -o yaru-theme.tar.gz https://github.com/pikriawan/arch-linux-install-script/raw/refs/heads/main/yaru-theme.tar.gz
    fi
...
if ! pacman -Qi bibata-modern-classic-cursor-theme &>/dev/null; then
    if [[ ! -f bibata-modern-classic-cursor-theme.tar.gz ]]; then
        curl -o bibata-modern-classic-cursor-theme.tar.gz https://github.com/pikriawan/arch-linux-install-script/raw/refs/heads/main/bibata-modern-classic-cursor-theme.tar.gz
    fi
...
if [[ ! -f .config.tar.gz ]]; then
    curl -o .config.tar.gz https://github.com/pikriawan/arch-linux-install-script/raw/refs/heads/main/.config.tar.gz
fi
...
if [[ ! -f opt.tar.gz ]]; then
    curl -o opt.tar.gz https://github.com/pikriawan/arch-linux-install-script/raw/refs/heads/main/opt.tar.gz
fi
...
if [[ ! -f bin.tar.gz ]]; then
    curl -o bin.tar.gz https://github.com/pikriawan/arch-linux-install-script/raw/refs/heads/main/bin.tar.gz
fi
